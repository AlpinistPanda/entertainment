...
# create movie objects for to show in the website

im_juli = media.Movie(
    "Im Juli", "Can Daniel follow the sun from Hamburg to \
    the Bosporus by Friday to meet his love?",
...
last_emperor = media.Movie(
    "The Last Emperor ", "The story of the final emperor of China. ",
    "https://upload.wikimedia.org/wikipedia/en/e/e5/The_Last_Emperor_filmposter.jpg",  # noqa
    "https://www.youtube.com/watch?v=QBUbmT8cCkM",
    "Bernardo Bertolucci")

seven_years_in_tibet = media.Movie(
    "Seven Years in Tibet",
    "True story of Heinrich Harrer, an Austrian mountain climber who became \
    friends with the Dalai Lama at the time of China's takeover of Tibet. ",
    "https://upload.wikimedia.org/wikipedia/en/9/97/Seven_Years_in_Tibet_cover.jpeg",  # noqa
    "https://www.youtube.com/watch?v=XCwy6lW5Ixc",
    "Jean-Jacques Annaud")

kundun = media.Movie(
    "Kundun", "From childhood to adulthood, Tibet's fourteenth Dalai Lama \
     deals with Chinese oppression and other problems.",
...
three_idiots = media.Movie(
    "3 Idiots",
    "Two friends looking for a lost buddy deal with a forgotten bet, a wedding \
    they are forced to crash and an out of control funeral.",
